          ...
          <aside class="usa-width-one-third usa-end-row">
            ...
            <p>
              <a class="media_link" href="{{ site.baseurl }}/">
                <img src="{{ site.baseurl }}/assets/img/robust_example_standardshome.png" alt="NASA Web Design Standards homepage example">
              </a>
              <a href="{{ site.baseurl }}/">NASA Web Design Standards homepage</a>
            </p>
          </aside>
          <h6 class="usa-heading-alt">Web Hierarchy</h6>
        </div>
