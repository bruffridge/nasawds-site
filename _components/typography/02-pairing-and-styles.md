          ...
          <aside class="usa-width-one-third usa-end-row">
            ...
            <p>
              <a class="media_link" href="/">
                <img src="{{ site.baseurl }}/assets/img/robust_example_standardshome.png" alt="Draft NASA Web Design Standards homepage example">
              </a>
              <a href="/">Draft NASA Web Design Standards homepage</a>
            </p>
          </aside>
          <h6 class="usa-heading-alt">Web Hierarchy</h6>
        </div>
