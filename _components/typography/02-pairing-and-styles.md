    ...
    <div id="font-pairing1-docs" class="usa-accordion-content">
      <div class="usa-grid-full">
        <div class="usa-width-two-thirds">
          ...
          <p>Usage: Add class <code>.usa-serif-body</code> to the section(s) containing your body text and Merriweather will be used on all paragraphs and list items within the section(s).</p>
      ...
      <div class="usa-grid usa-typography-example-font helvetica-style serif-body">
        ...
        <div class="usa-font-example usa-width-one-half usa-serif-body">
